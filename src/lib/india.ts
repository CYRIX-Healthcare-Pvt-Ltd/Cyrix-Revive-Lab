/**
 * India's states and union territories, and the districts in each.
 *
...
export const STATES: readonly string[] = Object.keys(INDIA)

/** The districts of one state, alphabetically — or none for an unknown state. */
export const districtsOf = (state: string | null | undefined): readonly string[] =>
  (state && INDIA[state]) || []
